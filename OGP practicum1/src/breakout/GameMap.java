...
public class GameMap {
	...
	private static final Vector INIT_BALL_VELOCITY = new Vector(5,7); // (5,7)
	...
	private static BlockState createBlock(Point bottomLeft) {
		...
		Point center = new Point( (blockTL.getX() + blockBR.getX())/2, (blockTL.getY() + blockBR.getY())/2 );
		return new BlockState(center, size);
	}
